...
The CFA Brigades Response Time to Incidents within their Areas (2019/20) {data-icon="ion-android-options"}
=================================================================================
Row
-----------------------------------------------------------------------
...
The CFA Brigades Response Time to Incidents within their Areas (2018/19) {data-icon="ion-android-options"}
=================================================================================
Row
-----------------------------------------------------------------------
...
The number of incidents for four quarters 2019/20-Summary {data-icon="ion-android-contact"}
=================================================================================
...
```{r}
ggplot(binding_data1, aes(x = CFA_Brigade_Area,
           y= Number_Incidents_total)) +       # Note that id is a factor. If x is numeric, there is some space between the first bar
  ...
  geom_text(binding_data1, aes(x=id, y=value+10, label=individual, hjust=hjust), color="black", fontface="bold",alpha=0.6, size=2.5, angle= label_data$angle, inherit.aes = FALSE ) 
