...
The mean time that it took CFA brigades to respond to incidents in their own CFA brigade areas is **eight minutes and thirty-seven seconds**. This is very close to the target response time for brigades, which is **eight minutes**. 
...
Let's visualize the data for the year 2018/19 quarter four for districts where it took between seven and twelve minutes to respond to an incident.
...
CFA official News https://news.cfa.vic.gov.au/-/cfa-release-latest-response-data
>>>>>>> 728afe3fe89d885c6893200da3f2ea1a0cfb9a0e
