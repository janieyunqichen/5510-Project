...
```{r plot-19, message=FALSE, fig.width=13, fig.height=12, fig.align='default'}
...
```{r plotIncidents, message=FALSE, fig.width=12, fig.height=8, fig.align='default', fig.cap="Number of incidents"}
...
```{r plotting, fig.width=12, fig.height=10, fig.align='default', fig.cap="Number of incidents for the fourth quarter 2019/20"}
ggplot(dat_Q4_2020,
...
```{r, message=FALSE, warning=FALSE, echo=TRUE, eval=TRUE, message=FALSE}
